...
public class UserAction extends BaseAction<User> {
	...
	public String delete() throws Exception {
		this.departmentService.delete(model.getId());
		return "toList";
	}
	...
	public String add() throws Exception {
		...
		// >> 设置所属部门
		model.setDepartment((Department) departmentService
				.getById(departmentId));
		// >> 设置关联的岗位
		List<Role> roleList = this.roleService.getByIds(roleIds);
	...
	public String editUI() throws Exception {
		...
		// 准备回显数据
		User user = (User) userService.getById(model.getId());
	...
	public String edit() throws Exception {
		...
		// >> 设置所属部门
		user.setDepartment((Department) departmentService.getById(departmentId));
		// >> 设置关联的岗位
